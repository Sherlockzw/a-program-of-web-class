...
<html>
    ...
    <body>
        <div id="dis_find">
          	员工信息添加
            <form action="../manServlet?act=add" method="post" name="form">
                ...
                <input type="submit" class="emp_update_btn" name="emp_add" value="添加">
            </form>
            <input type="button" class="buttonman5" name="return" value="返回" onclick="reBack()">
        </div>
    </body>
</html>